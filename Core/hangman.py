...
def guessLetter(words, usedletters):
    ...
    myfile = "C:\python\Graphics\ordboktemp.txt"
...
print(len(words))
words = setLength(words, 6)
print(len(words))

guess, usedletter = guessWord(words, usedletters)
usedletters.append(guess)
print(guess)

guess, usedletters = guessWord(words, usedletters)
print(guess)"""
